...
top_10_stats <- head(result[order(result$Mean, decreasing = TRUE), ], 5)

kable(top_10_stats, format = "html", col.names = c("Country", "Min", "Max", "Mean"), caption = "Top 10 Countries by Mean AI Patents", 
      align = c('l', 'c', 'c', 'c')) %>%
